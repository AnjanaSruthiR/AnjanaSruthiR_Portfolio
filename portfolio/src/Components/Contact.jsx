...
const Contact = () => {
  ...
  return (
    ...
    >
      <div
        className="absolute w-[500px] h-[500px] bg-gradient-to-r from-blue-400/30 via-purple-400/30 to-pink-400/30 rounded-full blur-[80px] pointer-events-none transition-transform duration-75 ease-out -translate-x-1/2 -translate-y-1/2 mix-blend-multiply z-0"
        style={{ 
