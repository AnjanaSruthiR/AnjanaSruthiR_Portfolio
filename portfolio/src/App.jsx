...
const App = () => {
  ...
  const categories = {
    ...
    "Tools": ["VS Code", "GitHub", "Jira", "Android Studio", "ServiceNow", "Office 365", "Excel"]
  };
  ...
  return (
    <div className="bg-white text-slate-900 min-h-screen font-sans selection:bg-purple-600 selection:text-white cursor-default overflow-x-hidden">
      ...
      <main className="relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8" data-aos="fade-right">
              ...
              <div className="text-xl md:text-2xl font-light text-slate-500">
                 I design <span ref={typedEl} className="text-purple-600 font-bold border-b-2 border-purple-200 pb-1"></span>
              </div>
              ...
              <div className="flex gap-4 pt-4">
                 ...
                 <a href={profile.email} className="w-12 h-12 flex items-center justify-center rounded-full border border-slate-100 text-[#ea4335] hover:bg-[#ea4335] hover:text-white hover:shadow-lg hover:shadow-red-500/30 transition-all">
        ...
        <section id="skills" className="bg-slate-950 text-white py-12 relative overflow-hidden">
           ...
           <div className="max-w-[1400px] mx-auto px-6 relative z-10">
              <div className="text-center mb-20" data-aos="fade-up">
                 <h2 className="text-5xl md:text-6xl font-black mb-4 tracking-tight">Tech Ecosystem</h2>
                       ...
                       <div className="flex flex-wrap justify-center gap-4">
                          {skills.filter(s => catSkills.includes(s.name)).map((tech, i) => (
                             <div 
                                key={i}
                                className={`
                                  group/icon relative flex items-center gap-3 px-5 py-3 rounded-xl 
                                  bg-white/5 border border-white/5 backdrop-blur-sm
                                  transition-all duration-300 cursor-default
                                  hover:-translate-y-2 hover:bg-slate-900
                                  ${idx === 0 ? 'animate-float-slow' : idx === 1 ? 'animate-float-medium' : 'animate-float-fast'}
                                `}
                             ...
                             >
                                <div className="absolute inset-0 rounded-xl opacity-0 group-hover/icon:opacity-100 transition-opacity duration-300"
                                     style={{ boxShadow: '0 0 20px var(--glow-color)', border: '1px solid var(--glow-color)' }}></div>
                                ...
                                <span className="font-bold text-sm text-slate-300 group-hover/icon:text-white relative z-10 transition-colors">
                                    {tech.name}
                                </span>
                             </div>
                          ))}
      ...
      <div id="projects" className="bg-slate-950 relative overflow-hidden">
